...
- Connect local dirs, git repos, npm packages, and websites — [Sources & Registries](docs/guides/sources-registries.md)
- Capture memories, import docs, and manage wikis — [Knowledge Management](docs/guides/knowledge-management.md)
- Turn feedback and usage into reviewable proposals — [The Improvement Loop](docs/guides/improvement-loop.md)
- Run resumable, multi-step procedures — [Workflows](docs/reference/workflows.md)
- Wire akm into Claude Code, OpenCode, Cursor, and other assistants — [Agent Integration](docs/guides/agent-integration.md)
