...
**Normative specification:** [AKM Format-Neutral Bundle Workspace Architecture Specification](./specs/akm-format-neutral-bundle-workspace-spec.md) (v0.3, amended in place)  
