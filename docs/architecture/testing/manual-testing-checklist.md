...
The stale-consolidation CLI recovery surface and its two skipped improve-memory
integration cases were removed in 0.9.2 ([#794](https://github.com/itlackey/akm/issues/794)).
