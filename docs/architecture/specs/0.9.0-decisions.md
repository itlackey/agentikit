...
ordered migration IDs, so it needs an exact-pin peer dependency. The core must
keep the pending-operation gate, ledger prefix refusal, and pointer messages.
