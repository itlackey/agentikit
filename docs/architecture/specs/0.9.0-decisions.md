...
state across a rename is opt-in and out-of-band: `bun
scripts/rekey-asset-ref.ts <old-ref> <new-ref>`, run from a source checkout
...
[`v0.9.0-troubleshooting.md`](../../migration/v0.9.0-troubleshooting.md).
