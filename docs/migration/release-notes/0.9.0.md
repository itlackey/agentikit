...
Release validation passed on 2026-07-31. `bun run release:check` verified the
packed npm installation, Node fallback and Bun launcher paths, migration and
task execution from published 0.8.14, the Linux standalone scheduler artifact,
2,953 unit tests, 5,061 integration tests, and all seven Docker install targets.
