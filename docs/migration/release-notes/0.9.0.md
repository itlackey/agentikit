...
including real `SIGKILL` windows across migration, proposal, workflow, and lock
journals. The container also passed `release:check --skip-docker`, the seven-image
