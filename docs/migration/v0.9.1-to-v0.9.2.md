...
Only a stored v3 plan may retain the historical flag, and that stored v3 run
resumes unchanged; the compatibility reader does not make the flag valid for
new authoring.
