...
Never include the truncation marker (the literal text `... [truncated — focus on the visible portion]`) or any other text from outside the quoted asset content shown to you, anywhere in `content`.
